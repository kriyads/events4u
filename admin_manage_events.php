...
<html>
 ...
 <div id="cssmenu"><!--class="fs-special-view-left-menu"-->
        <ul>
          <li class="has-sub"><a href='admin_profile.php' ><span class="glyphicon glyphicon-user"></span>Admin Profile</a>
            <ul  id="currentMenu" style="display: block">
              ...
              <li><a    class="currentsubLink"  href="admin_manage_events.php"  class="unselected">Manage Events</a></li>
    ...
    <div class="rightArea">
      ...
      <div class="heading">
        <div style="float:left;width:30%;"><h2>Manage Events</h2></div>
        <!--
                -->
      </div>
      ...
      <!--Data Section Start-->
		...
		$search=mysqli_query($conn,"SELECT * FROM event_details");
		...
		?>
		 ...
		 if($search){
			...
			echo"<td>$t_qty</td>";
			echo"<td>$t_price</td>";
			echo"<td><a href='admin_manage_events.php?del=$eventid' title='Delete Record' onclick='return confirm('Do you want to delete');'>Delete<i class=''></i></a></td>";
