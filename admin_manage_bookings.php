 ...
 <div id="cssmenu"><!--class="fs-special-view-left-menu"-->
         <ul>
          <li class="has-sub"><a href='admin_profile.php' ><span class="glyphicon glyphicon-user"></span>Admin Profile</a>
            <ul  id="currentMenu" style="display: block">
              ...
              <li><a   	class="currentsubLink"  href="admin_manage_bookings.php"  class="unselected">Manage Bookings</a></li>
              <
            </ul>
          </li>
    ...
    <div class="rightArea">
      ...
      <!--Data Section Start-->
		...
		$search=mysqli_query($conn,"SELECT * FROM event_details inner join booking_details where event_details.e_id=booking_details.e_id");
		...
		?>
		 ...
		 if($search){
			...
			echo"<td><a href='admin_manage_bookings.php?del=$eventid' title='Delete Record' onclick='return confirm('Do you want to delete');'>Delete<i class=''></i></a></td>";
