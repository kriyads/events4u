...
<?php
				...
				if(isset($_POST['submit'])){
					...
					$search=mysqli_query($conn,"SELECT * FROM event_details where EventName LIKE '$ename%'");
					$row=mysqli_fetch_assoc($search);
					$eventid=$row['EventID'];
					header('location:search_user_event.php?eventid='.$eventid);
...
<a target="_self" href=""><img src='images/1.jpg'	width="1280" height="370" alt="PMIWB" title="PMIWB" /></a>
...
<li class="col-xs-12 col-sm-6 col-md-4 col-lg-4 thumbBlock bookmarkid_229839">
	<div class="event-box-shadow">
		...
		<form action='user_event_detail.php' method='POST'>
			<div class="eventImg">
			...
			<div class="eventpadding">
				...
				<div class="info">
					<span content="2020-04-29 15:30:00"><i class="icon2-calendar-o"></i>From:<?php  echo "$s_date"; ?> To:<?php  echo "$e_date"; ?></span>
					<input type="hidden" name="eventid" value="<?php echo"$EventID"; ?>" class="form-control" readonly>
				</div>
		...
		<center><input type="submit" class="btn btn-info btn-sm" value="Book Events"/></center>
		</form>
</div>
</li>  
