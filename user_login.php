...
if(isset($_POST['submit'])){
					...
					$search=mysqli_query($conn,"SELECT * FROM user_details where UserID='$email' and UserPassword='$password'");
					...
					header('location:home.php');
						...
						echo"<script>alert('Invalid UserId and Password'); window.location.href='user_login.php';</script>";
            ...
            <div class="col-sm-6 rightSide">
                <div class="loginBlog">              
                    ...
                    <form novalidate name="loginForm" method="post">
                        <div class="form-group">
                            <input type="email" name="email"  value=""  class="form-control userFields" placeholder="Email">
					...
					<span> <label >New to Events4u?</label> <a href="registration.php">Sign Up</a></span> </div>
            </div>
