...
<html>
    <head>
        ...
        <script src="js/jQuery.min.js.gz?v=131"></script>        
                <title>Explore latest, upcoming and most happening events. Book your tickets now.</title> 
                <meta name="viewport" content="width=device-width,initial-scale=1.0">
					...
					<div class="input-group-btn">
					  <button class="btn btn-default" type="submit" name="submit1">
						<i class="glyphicon glyphicon-search"></i>
							...
							<li><a href="user_login.php"><span class="glyphicon glyphicon-edit"></span>&nbsp;Create Events</a></li>
        ...
        <div class="img_below_cont ">
            <h1><?php echo"$event"; ?></h1>
                            <div class="sub_links"><span class="icon-calender"></span>                       
                                            <?php echo"$s_date"; ?> To <?php echo"$e_date"; ?> | <?php echo"$s_time"; ?> To <?php echo"$e_time"; ?> IST                                        
							</div>
                        ...
                        <div class="cont_main">
                            ...
                            <div class="eventCatSelect">
								...
								if($t_qty<1){
									...
									<input type='number' class="form-control eventFields " name='t_qty'/>
            ...
            <div class="clearfix"></div>
                ...
                <div class="col-sm-4 col-xs-12 col-md-3 col-md-offset-1">
					...
					<form method="post" action="registration.php"
                        <p><input type="submit" class="btn btn-primary" value="Book Event"/></p>
